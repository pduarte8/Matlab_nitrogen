...
% =========================
%load('Profile_Regression_Results_all_profiles_ice_regime_min_ice-covered.mat')
load('Profile_Regression_Results_all_profiles_ice_regime_max_ice-covered.mat')
...
IceRegime  = [Results.IceRegime];
keep = Regression == "NO3_vs_SA" & ...
       Accepted   == "linear"    & ...
       Slope ~= 0               & ...
       IceRegime == 1 & ...
       ~contains(Sector,'Barents');
